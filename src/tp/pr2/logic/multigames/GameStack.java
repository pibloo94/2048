...
public class GameStack {
	...
	/**
	 * metodo getBoardListUndo
	 * 
	 * @return GameState[]
	 */
	public GameState[] getBoardListUndo() {
		return boardListUndo;
	}

	/**
	 * metodo getBoardListRedo @returnGameState[]
	 * @return GameState[]
	 */
	public GameState[] getBoardListRedo() {
		return boardListRedo;
	}
